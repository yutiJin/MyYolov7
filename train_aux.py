...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov7-d6_training.pt', help='initial weights path')
    ...
    parser.add_argument('--name', default='exp_d6', help='save to project/name')
